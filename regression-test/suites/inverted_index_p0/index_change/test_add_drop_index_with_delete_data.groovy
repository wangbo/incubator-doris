...
suite("test_add_drop_index_with_delete_data", "inverted_index"){
    ...
    select_result = sql "select * from ${indexTbName1} where description match 'hello' order by id"
    ...
    select_result = sql "select * from ${indexTbName1} where description match 'world' order by id"
    assertEquals(select_result.size(), 3)
    ...
    select_result = sql "select * from ${indexTbName1} where description match 'ok' order by id"
    ...
    // query all rows
    select_result = sql "select * from ${indexTbName1} order by id"
    assertEquals(select_result.size(), 3)
    assertEquals(select_result[0][0], 1)
    assertEquals(select_result[0][1], "name1")
    assertEquals(select_result[0][2], "desc test hello")
