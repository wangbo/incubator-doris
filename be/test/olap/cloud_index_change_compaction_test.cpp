...
TEST_F(CloudIndexChangeCompactionTest, build_output_schema_drop_test) {
    ...
    *mock_pb_schema.mutable_tablet_uid() = TabletUid::gen_uid().to_proto();
    ...
    const TabletIndex* col2_index = input_tablet_schema->inverted_index(col2_column);
    ...
    ASSERT_TRUE(output_schema->inverted_index(col2_column) == nullptr);
...
TEST_F(CloudIndexChangeCompactionTest, build_output_schema_add_test) {
    ...
    *mock_pb_schema.mutable_tablet_uid() = TabletUid::gen_uid().to_proto();
    ...
    const TabletIndex* col3_old_index = input_tablet_schema->inverted_index(col3_column);
    ...
    const TabletIndex* col3_new_index = output_schema->inverted_index(col3_column);
