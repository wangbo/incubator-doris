...
public class WorkloadGroupMgr implements Writable, GsonPostProcessable {
    ...
    private final WorkloadGroupProcNode procNode = new WorkloadGroupProcNode();
    ...
    public List<TPipelineResourceGroup> getWorkloadGroup(String groupName) throws UserException {
        List<TPipelineResourceGroup> workloadGroups = Lists.newArrayList();
        readLock();
        try {
    ...
    private void checkAndCreateDefaultGroup() {
        ...
        try {
            ...
            LOG.warn("Create work load group " + DEFAULT_GROUP_NAME + " fail");
        } finally {
            writeUnlock();
        }
    ...
    public void alterWorkloadGroup(AlterWorkloadGroupStmt stmt) throws DdlException {
        ...
        LOG.info("Alter workload group success: {}", newWorkloadGroup);
    }
    ...
    public List<List<String>> getWorkloadGroupInfo() {
    ...
    public class WorkloadGroupProcNode implements ProcNodeInterface {
        @Override
